...
phonons = pd.read_csv("./b.welph.save.pdep1000/phonon_iq00001.csv",sep="\\s+",names=["imode","au","thz","cmm"],skiprows=1)
...
#plt.show()
fig.savefig("dos-4x4x4.png",bbox_inches="tight",dpi=300)
