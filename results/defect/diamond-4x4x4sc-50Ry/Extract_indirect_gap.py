...
prefix = "./c.welph.save/"
zpr_dft_adi, zpr_gw_adi = extract_zpr(prefix,vbm=256,cbm=257,enable_gw=True,adiabatic=True)
zpr_dft_nad, zpr_gw_nad = extract_zpr(prefix,vbm=256,cbm=257,enable_gw=True,adiabatic=False)
