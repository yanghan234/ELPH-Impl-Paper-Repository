...
prefix = "./60Ry-myrelax/c.welph.save.pdep200.backup/"
zpr_dft_adi, zpr_gw_adi = extract_zpr(prefix,vbm=4,cbm=5,enable_gw=False,adiabatic=True)
zpr_dft_nad, zpr_gw_nad = extract_zpr(prefix,vbm=4,cbm=5,enable_gw=False,adiabatic=False)
